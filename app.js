(() => {
  ...
  const SPECIAL = {
    SPACE: {
      ...
      kind: "special",
      match: (e) => e.key === " ",
      displayHtml: () => `<span class="keyIcon" aria-hidden="true">⎵</span><span class="srOnly">Space</span>`,
      displayText: () => " ",
    },
    ENTER: {
      id: "ENTER",
    ...
    BACKSPACE: {
      ...
      displayHtml: () => `<span class="keyIcon" aria-hidden="true">⌫</span><span class="srOnly">Backspace</span>`,
  ...
  const KB_LAYOUT = [
    {
      ...
      keys: [
        ...
        { id: "-", label: "-" },
        { id: "=", label: "=" },
        { id: "BACKSPACE", label: "BACKSPACE", w: "backspace" },
      ],
    },
    {
      cls: "kbdRow",
